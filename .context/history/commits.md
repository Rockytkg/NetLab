...
| 2026-07-18 | b7d43d00 | refactor | ♻️ refactor(admin): 清扫冗余：移除未使用代码并抽取公共加载逻辑 | 移除 auth middleware 未使用常量和 GetUsername()<br/>移除 User 模型未使用的 IsLocked/IsPrivileged/IsSuperAdmin<br/>前端设置页抽取公共 loadSettings + alive 守卫<br/>移除 types/api.ts 未使用的 ApiResponse/PageParams/PageResult | - |
