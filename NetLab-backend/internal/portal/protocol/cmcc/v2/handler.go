...
// Processor is injected by the Portal service in Phase 4. It keeps wire code
// independent from databases and authentication providers.
...
func (h *Handler) Profile() protocol.Profile              { return protocol.ProfileCMCCV2 }
