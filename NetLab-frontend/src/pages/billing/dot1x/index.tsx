    ...
    <div style={{ width: '100%' }}>
      <Card variant="outlined" loading={loading}>
        ...
        <Form form={form} layout="vertical" requiredMark={false} onFinish={handleSave}>
          <Divider titlePlacement="start">{t('radius:eap.sections.general')}</Divider>
          <Row gutter={[24, 0]}>
            <Col xs={24} sm={8}>
              <Form.Item
                name="enabled"
                label={t('radius:eap.form.enabled')}
          ...
          <Divider titlePlacement="start">{t('radius:eap.sections.tls')}</Divider>
          <Row gutter={[24, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item
